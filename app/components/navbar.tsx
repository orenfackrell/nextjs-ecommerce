...
export function NavMenu() {
  return (
    <div className="w-[1440px] h-[77px] p-6 justify-start items-center gap-6 inline-flex">
      <div className="grow shrink basis-0 h-[29px] justify-start items-center gap-2 flex">
        <NavigationMenu>
          <NavigationMenuList>
                    ...
                    <NavigationMenuLink asChild>
                      ...
                      >
                        ...
                        <p className="text-sm leading-tight text-muted-foreground">
                          Hand Crafted by our team, these starter kits are the perfect way to get
                          into making your own terrarium.
                        </p>
                      </a>
                    </NavigationMenuLink>
                  </li>
